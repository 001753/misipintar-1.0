...
"[project]/src/app/apple-icon--route-entry.js [app-route] (ecmascript, async loader)", ((__turbopack_context__) => {

__turbopack_context__.v((parentImport) => {
    return Promise.resolve().then(() => {
        return parentImport("[project]/src/app/apple-icon--route-entry.js [app-route] (ecmascript)");
    });
});
}),
];