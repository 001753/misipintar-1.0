...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://mp.jobenapp.cloud/register',
  },
  openGraph: {
...
const softwareAppSchema = {
  ...
  screenshot: 'https://mp.jobenapp.cloud/screenshot.png',
  ...
  potentialAction: {
    ...
    target: {
      '@type': 'EntryPoint',
      urlTemplate: 'https://mp.jobenapp.cloud/register',
    },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Daftar Gratis',
      item: 'https://mp.jobenapp.cloud/register',
    },
  ],
}
