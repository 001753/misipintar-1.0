                ...
                <div className="p-8">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full py-3.5 rounded-2xl border border-slate-200 dark:border-gray-700 text-slate-600 dark:text-gray-400 font-semibold text-sm hover:bg-slate-50 dark:hover:bg-gray-800 transition-colors"
                    >
                      Tambah Misi Lainnya
                    </button>
                  </motion.div>
