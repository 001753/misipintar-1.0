    ...
    <div className="space-y-4 pt-2">
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm">
          ...
          <div className="space-y-2">
            {pendingTasks.map((task) => (
              <Link
                ...
                className="flex items-center justify-between p-3 bg-gray-50 rounded-xl hover:bg-emerald-50 transition-colors"
              >
                <div>
        ...
        {pendingTasks.length > 0 && (
          <Link
            href="/child/tasks"
            className="block text-center text-xs text-emerald-600 hover:text-emerald-700 font-medium mt-3"
          >
            Lihat semua tugas →
          </Link>
        )}
